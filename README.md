...
- `座標情報`：默认从 `1,2,3,4` 开始按项目连续编号；即使错误Pattern增加或复制项目，
  也会重新分配重复坐标，保证同一TXT内不重复。
...
```text
"1001","1","1001","傷病名1","0","1,2,3,4","1002","1","0","5,6,7,8"
```

全网罗账票的正常Pattern `4001_01_normal.txt`：

```text
"4001","1","2001","5/8/6/1","0","1,2,3,4","2002","/2026/6/1","0","5,6,7,8","2003","5/2026/6/1","0","9,10,11,12","2004","5/8/6/1|5/8/6/2","0","13,14,15,16"
```
